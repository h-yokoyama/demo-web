        ...
        <el-table :data="currencies" style="width: 100%">
          ...
          >
            <template slot-scope="scope">
              <test-list v-on:onModal="onModal(true, scope.row)" />
              <test-modal
                v-bind:dialogVisible="dialogVisible"
                v-bind:val="selectedCurrency"
                v-on:onModal="onModal(false, selectedCurrency)"
                v-on:updateCurrency="updateCurrency(selectedCurrency)"
              />
              <el-button
                size="mini"
                type="danger"
...
export default {
  ...
  methods: {
    ...
    onModal: function(dialogVisible, selectedItem) {
